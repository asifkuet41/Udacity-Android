...
public class MapAnimator {
    ...
    public void animateRoute(final GoogleMap googleMap, List<LatLng> bangaloreRoute) {
...
//        });
        ...
        final ObjectAnimator foregroundRouteAnimator = ObjectAnimator.ofObject(this, "routeIncreaseForward", new RouteEvaluator(), bangaloreRoute.toArray());
